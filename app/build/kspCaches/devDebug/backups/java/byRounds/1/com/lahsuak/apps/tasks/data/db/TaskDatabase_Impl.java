    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(4) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoTaskTable.equals(_existingTaskTable)) {
          return new RoomOpenHelper.ValidationResult(false, "task_table(com.lahsuak.apps.tasks.data.model.Task).\n"
                  + " Expected:\n" + _infoTaskTable + "\n"
                  + " Found:\n" + _existingTaskTable);
        }
        ...
        if (!_infoSubTaskTable.equals(_existingSubTaskTable)) {
          return new RoomOpenHelper.ValidationResult(false, "sub_task_table(com.lahsuak.apps.tasks.data.model.SubTask).\n"
                  + " Expected:\n" + _infoSubTaskTable + "\n"
        ...
        if (!_infoNotificationTable.equals(_existingNotificationTable)) {
          return new RoomOpenHelper.ValidationResult(false, "notification_table(com.lahsuak.apps.tasks.data.model.Notification).\n"
